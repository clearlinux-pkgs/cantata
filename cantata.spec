...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646327277
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/cantata-2.5.0/3rdparty/ebur128/COPYING %{buildroot}/usr/share/package-licenses/cantata/2627ff03833f74ed51a7f43c55d30b249b6a0707
cp %{_builddir}/cantata-2.5.0/3rdparty/kcategorizedview/COPYING %{buildroot}/usr/share/package-licenses/cantata/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/cantata-2.5.0/3rdparty/kcategorizedview/COPYING.LIB %{buildroot}/usr/share/package-licenses/cantata/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/cantata-2.5.0/3rdparty/qtiocompressor/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/cantata/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/cantata-2.5.0/3rdparty/qtsingleapplication/LICENSE.LGPL %{buildroot}/usr/share/package-licenses/cantata/caeb68c46fa36651acf592771d09de7937926bb3
cp %{_builddir}/cantata-2.5.0/3rdparty/qxt/LICENSE %{buildroot}/usr/share/package-licenses/cantata/3f3ade74b4071609a90853616f8db5f76a3db568
cp %{_builddir}/cantata-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/cantata/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/cantata-2.5.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/cantata/57c3cb6b9aee09ae2af06b0c517e2969d2f33d47
cp %{_builddir}/cantata-2.5.0/windows/LICENSE.txt %{buildroot}/usr/share/package-licenses/cantata/7713a1753ce88f2c7e6b054ecc8e4c786df76300
pushd clr-build
%make_install
popd
